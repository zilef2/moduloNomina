            ...
            <div class="px-4 sm:px-0">
                <div class="rounded-lg overflow-hidden w-fit">
                    ...
                    <Create :show="data.createOpen" @close="data.createOpen = false"
                        ...
                        :ArrayCentrosNoFactura="props.ArrayCentrosNoFactura" :disabled=disableCreate />
                    ...
                    <Reporte_Super_Edit :show="data.Reporte_Super_EditOpen" @close="data.Reporte_Super_EditOpen = false"
                        :Reporte="data.generico" :title="props.title" :valoresSelect="props.valoresSelect"
                        :showUsers="props.showUsers" :correccionUsuario="false" />


                    <Delete :show="data.deleteOpen" @close="data.deleteOpen = false" :Reporte="data.generico"
                        v-show="can(['delete reporte'])" :title="props.title" />
...
<!--                                    <ChevronUpDownIcon v-if="nombresTabla[2][indiceN] !== null" class="w-4 h-4" />-->
                    ...
                    <tbody>
                        ...
                        <tr v-show="props.sumhoras_trabajadas != 0"
                            ...
                            <td class="whitespace-nowrap py-4 px-2 sm:py-3">
                                {{
                                    props.sumdominical_extra_diurno ? 'Dominical extra diurno: ' +
                                        props.sumdominical_extra_diurno : ''
                                }}
                            </td>
                            <td class="whitespace-nowrap py-4 px-2 sm:py-3">
                                {{
                                    props.sumdominical_extra_nocturno ? 'Dominical extra nocturno: ' +
                                        props.sumdominical_extra_nocturno : ''
                                }}
                            </td>
                            <td class="whitespace-nowrap py-4 px-2 sm:py-3"></td>
                            <td class="whitespace-nowrap py-4 px-2 sm:py-3"></td>
