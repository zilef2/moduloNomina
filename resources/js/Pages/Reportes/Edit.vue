...
const recuperarHoras = (ReporteRecuperado) => {
    ...
    form.nocturnas = ReporteRecuperado.nocturnas
    form.extra_diurnas = ReporteRecuperado.extra_diurnas
    form.extra_nocturnas = ReporteRecuperado.extra_nocturnas
    form.dominical_diurnas = ReporteRecuperado.dominical_diurnas
    ...
    form.fecha_ini = ReporteRecuperado.fecha_ini
...
watchEffect(() => {
    if (props.show) {
        ...
        console.log("🚀🚀 ~ ReporteRecuperado: ", ReporteRecuperado);
        form.errors = {}
        nextTick()
        ...
        <Modal :show="props.show" @close="emit('close')" :maxWidth="'xl4'">
            <form class="p-6" @submit.prevent="update">
                ...
                <div class="flex justify-end">
                    ...
                    <PrimaryButton v-if="correccionUsuario" class="ml-3" :class="{ 'opacity-25': form.processing }"
