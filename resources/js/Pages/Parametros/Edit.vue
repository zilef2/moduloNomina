                ...
                <div class="my-6 grid grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <TextInput id="subsidio_de_transporte_dia" type="number" class="mt-1 block w-full" v-model="form.subsidio_de_transporte_dia" required
                            :placeholder="lang().placeholder.subsidio_de_transporte_dia" :error="form.errors.subsidio_de_transporte_dia" />
                    ...
                    <div>
                        ...
                        <TextInput id="salario_minimo" type="number" class="mt-1 block w-full" v-model="form.salario_minimo" required
                            :placeholder="lang().placeholder.salario_minimo" :error="form.errors.salario_minimo" />
