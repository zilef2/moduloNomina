<script setup>
    import AuthenticatedLayout from '@/Layouts/AuthenticatedLayout.vue';
        ...
        import {number_format,formatDate, monthName } from '@/global.js';
                    ...
                    <table class="w-full">
                        ...
                        <tbody>
                            ...
                            <tr class="border-t border-gray-200 dark:border-gray-700 hover:bg-gray-200/30 hover:dark:bg-gray-900/20">
                                ...
                                <td class="whitespace-nowrap py-4 px-5 sm:py-3"> {{ PasarDiaAQuincena(fromController[0]['subsidio_de_transporte_dia']) }} </td>
                            </tr>
                        </tbody>
                    </table>
                </div>
