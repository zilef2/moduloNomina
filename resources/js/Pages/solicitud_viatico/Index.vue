...
// Observar cambios en el perPage para recargar datos (opcional - descomenta si necesitas recargar al cambiar perPage)
...
const hasColFilters = computed(() =>
    ...
    data.params.col_obra || data.params.col_saldo || data.params.col_fecha
)
            ...
            <div class="relative bg-white dark:bg-gray-800 shadow sm:rounded-lg">
                ...
                <div class="overflow-x-auto scrollbar-table">
                    <table class="w-full">
                        ...
                        <div v-else class="flex flex-col items-center justify-center py-16 mx-auto">
                            <p class="text-3xl font-semibold tracking-wide mx-auto
                                    bg-gradient-to-r from-slate-900 via-slate-500 to-slate-400
                                    bg-clip-text text-transparent">
                                Sin registros 🤷‍♂️
                            </p>
                            <div class="mt-4 w-24 h-1 rounded-full bg-indigo-600" />
                        </div>
                    </table>
                </div>
                <div v-if="totalFiltered > 0"
                    ...
                    <div class="text-sm text-gray-600 dark:text-gray-400">
                        Mostrando {{ (currentPage - 1) * data.params.perPage + 1 }} - {{ Math.min(currentPage * data.params.perPage, totalFiltered) }} de {{ totalFiltered }} registros
                    </div>
