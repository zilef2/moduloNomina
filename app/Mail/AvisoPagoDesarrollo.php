...
class AvisoPagoDesarrollo extends Mailable
{
    ...
    public function __construct(Desarrollo $desarrollo, int $cuantosDesarrollosPendientes)
    {
        ...
        // fecha de vencimiento = fecha_cotizacion_aceptada + 1 mes
//        $this->fechaVencimiento = Carbon::parse($desarrollo->fecha_cotizacion_aceptada)->addMonth()->format('d/m/Y');
    ...
    {
        return new Envelope(
            subject: 'Aviso de pago pendiente - ' . $this->desarrollo->nombre,
        );
    }
    ...
    {
        return new Content(
            markdown: 'emails.aviso-pago-desarrollo',
        );
    }
}